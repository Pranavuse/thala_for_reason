...
import dance from "..//components/dance.jpg";
...
const Thalasum = () => {
  ...
  const checkThala = () => {
    ...
    if (sum === 7) {
      ...
      // document.body.style.backgroundImage = `url(${dance})`;
      ...
      <div className="card container">
        ...
        <div className="gap-3 flex flex-row">
          <input
            ...
            autocomplete="off"
            className="w-full outline-none p-2 border rounded m-2"
          />
          <button
            onClick={checkThala}
            type="submit"
            className="btn btn-primary text-white bg-blue-500 rounded shadow shadow-black"
          >
            Check Thalavity
          </button>
        </div>
